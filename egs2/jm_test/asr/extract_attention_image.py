...
def save_encoder_image(image_list, name, n_layers, n_heads, PATH):
    fig_saved_dir = PATH
...
def save_decoder_image(image_list, name, n_layers, n_heads, PATH, mode='self'):
    fig_saved_dir = PATH
...
if __name__ == "__main__":
    ...
    file_name_list = []
    audio_num = 5 # selelct one of the wav in file_name_list
    ...
    # save_encoder_image(saved_encoder_self_attn_images, 'encoder_self_attn', 18, 8, './exp/feature_images/encoder_self_attn/')
    # save_decoder_image(saved_decoder_self_attn_images, 'decoder_self_attn', 6, 8, './exp/feature_images/decoder_self_attn/', 'self')
    save_decoder_image(saved_decoder_src_attn_images, 'decoder_src_attn', 6, 8, './exp/feature_images/decoder_src_attn/', 'src')